...
robin.role("wdidc6", "admin").observe("jane", "Jane is cool. A+", "green")
robin.role("wdidc6", "admin").observe("jane", "Jane is no longer cool", "red")
jesse.role("wdidc6", "admin").observe("jane", "Jane smells", "yellow")
andy.role("wdidc6", "admin").observe("jane", "Basically wrote Facebook for final project", "green")
robin.role("wdidc6", "admin").observe("joe", "Joe is lame. F-", "red")
